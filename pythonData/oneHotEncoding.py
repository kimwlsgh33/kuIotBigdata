...
def main():
    ...
    house_oneHot["Single Family"] = [
        1 if pt == "Single Family" else 0 for pt in house["PropertyType"]
    ]
    house_oneHot["Townhouse"] = [
        1 if pt == "Townhouse" else 0 for pt in house["PropertyType"]
    ]
    house_oneHot["Multiplex"] = [
        1 if pt == "Multiplex" else 0 for pt in house["PropertyType"]
    ]
